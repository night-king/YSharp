    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<IdentityOptions>(options =>
            {
                ...
                // User settings
                options.User.RequireUniqueEmail = true;//需要使用email找回密码，所以必须邮箱唯一
            ...
            services.ConfigureApplicationCookie(options =>
            {
                ...
                options.ExpireTimeSpan = TimeSpan.FromDays(30);//每30天登录一次
            ...
            {
                options.AddPolicy("RolePolicy", policy => policy.Requirements.Add(new CustomRoleRequirement()));
            });
