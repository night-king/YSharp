...
namespace YSharp.Repository.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbsolutelyUrl = table.Column<string>(maxLength: 1000, nullable: true),
                    RequestIP = table.Column<string>(maxLength: 128, nullable: true),
                    ...
                    SpendMilliseconds = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VirtualPath = table.Column<string>(maxLength: 1000, nullable: true),
                    AbsolutePath = table.Column<string>(maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IPAddress", x => x.IP);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_AccepterId",
